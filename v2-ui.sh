...
#   Github - v2-ui: https://github.com/sihankumar/v2-ui
#======================================================
...
uninstall() {
    ...
    echo -e "Github issues: ${green}https://github.com/sihankumar/v2-ui/issues${plain}"
...
install_bbr() {
    bash <(curl -L -s https://github.com/sihankumar/v2-ui/raw/master/bbr.sh)
    if [[ $? == 0 ]]; then
        echo ""
